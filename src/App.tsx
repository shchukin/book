  ...
  return (
    <>
      ...
      <Lesson>
        ...
        ู [уː] - знак гласной [у:] располагается под согласной буквой под правым краем.
        ...
        Прослушайте и повторяйте за диктором слоги с долгими гласными ровным тоном.
        а) открытые слоги:

        กา ตา ปา ซา ยา มา วา นา กอ ปอ ตอ ซอ มอ ยอ วอ นอ กู ปู ตู ยู มู วู นู กี ปี ตี ซี ยี มี นี
        б) закрытые слоги:

        กาม กาย ตาย ตาว ปาน ปาม ปาว ซาน ซาย วาน กอน ตอน ปอย นอน ยอย ตูน ปูน มูน นูม ตีน วีม ยีน


        Прослушайте и повторяйте за диктором слоги с долгими гласными восходящим тном:
        а) открытые слоги:

        ผา ขา ถา สา หา หยา หมา ถู หู หมู หนู หวู หยู ขอ สอ หอ หมอ หนอ หยอ หนี หมี สี หวี หยี

        б) закрытые слоги:

        ผาน ขาม ถาว สาย หาน ถาย หาย ผอม ขอม ถอย สอน หอย ถูม สูน ขูน หูม ผีน หนีม หวีม

        Прослушайте и повторяйте за диктором слоги с гласной [и:].
        ผี ขี ถี สี ปี กี ตี ซี พี คีม ปีน ตีน ซีน ทีม ผีน

        Прослушайте и повторяйте за диктором пары слогов, которые различаются непридыхательными и придыхательными согласными в начале слога:

        กา – คา กาย – คาย ตาว – ทาว ปาว – พาว ตี – ที ปอ – พอ กอย – คอย ตู – ทู ปี – พี ปูม – พูม

        Прослушайте и повторите за диктором пары слогов ровным и восходящим тоном.

        พี – ผี คา – ขา ซา – สา ฮา – หา วา – หวา ทาว – ถาว นาว – หนาว ยอม – หยอม คอม - ขอม ซอย -สอย ที – ถี มี – หมี ยู – หยู

        Прослушайте и повторите за диктором пары слогов восходящим и ровным тоном.

        ผา – พา ถาว – ทาว หวาน – วาน หา – ฮา นาย – หนาย ขอ – คอ หยอ – ยอ ขอม – คอม สอย– ซอย ถี – ที หมี – มี สู – ซู หนู – นู

        Преобразуйте слог с ровным тоном в слог с восходящим тоном (ˇ), заменив начальную букву в данных слогах:

        พอม คา ทู ซอน ฮอ ยี มา วี นา ทาม วาน คาย มี ทอน ฮาย พี ยาม นู ซี ฮู นอน มาย

        Преобразуйте слог с восходящим тоном (ˇ) в слог с ровным тоном:
